# Loop MMT CMS — Master Implementation Plan v1.11
...
**What this plan replaces.** CMS Master Implementation Plan v1.10 is superseded. This plan integrates 122 total findings from twelve review passes (including 12 L21 isomorphisms). For mechanism detail, read the source documents.
